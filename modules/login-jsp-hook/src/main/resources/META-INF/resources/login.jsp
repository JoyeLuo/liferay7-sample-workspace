...
<c:choose>
    ...
    <c:otherwise>
        ...
        <aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' cssClass="sign-in-form" method="post" name="<%= formName %>" onSubmit="event.preventDefault();">
            ...
            <c:choose>
                <c:when test='<%= SessionMessages.contains(request, "customErrorUserCreationFailed") %>'>
                <!-- Errors are already added in SessionMessages -->
                </c:when>            
                ...
                <c:when test='<%= SessionMessages.contains(request, "userAdded") %>'>
                    ...
                    <div class="alert alert-success">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <liferay-ui:message arguments="<%= userPassword %>" key="thank-you-for-creating-an-account" translateArguments="<%= false %>" />
                            </c:otherwise>
                        </c:choose>
            ...
            <liferay-ui:error key="user.account.creation.failed.user.details.updation" message="Not able to update user details in liferay" />
            <liferay-ui:error key="user.account.creation.failed.userservice" message="Not able to create user account in user service" />
